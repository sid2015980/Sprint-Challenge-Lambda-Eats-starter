...
It does the same thing that a <Route> would do, without having to render a route. It tries to match the current URL.
****************************************

***************************************
2. How would you explain form validation to someone who has never programmed before?

form validation is a way to ensure that forms are filled out properly by matching what a user writes, vs. what is expected in the fields.
***************************************************

*************************************************
3. In 1-2 sentences, define end to end testing. 

The purpose of end-to-end testing it to ensure that data integrity id kept across the application as a user interacts with a site, making sure it is behaving properly. 
************************************
